...
case_name = 'COVID19_3st_wave_RJ'

df = load_data('COVID19_Data_RJ_Jan_01_2020_to_Dec_31_2021.csv')

# raw data start/end
RawDataStart = '2020-11-01' #306
RawDataEnd = '2021-03-01' #426

#  training data start/end
TrainDataStart = '2020-11-01' #306;
TrainDataEnd   = '2021-02-01' #398;
...
K0   = Cmax
ExpDataStart = '2020-11-01' #306=
ExpDataEnd = '2020-12-10' #306+40=346
