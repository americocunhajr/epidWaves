...
case_name = 'COVID19_5st_wave_RJ'

df = load_data('COVID19_Data_RJ_Jan_01_2020_to_Dec_31_2021.csv')

# raw data start/end
RawDataStart = '2021-03-01' #426
RawDataEnd = '2021-07-01' #548

#  training data start/end
TrainDataStart = '2021-05-01' #487
TrainDataEnd   = '2021-07-01' #548
...
K0   = 2*Cmax
ExpDataStart = '2021-03-01' #426
ExpDataEnd = '2021-03-30' #426+30=456
