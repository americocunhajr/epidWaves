...
case_name = 'COVID19_2st_wave_RJ'

df = load_data('COVID19_Data_RJ_Jan_01_2020_to_Dec_31_2021.csv')

# raw data start/end
RawDataStart = '2020-07-01' #183
RawDataEnd = '2020-11-01' #306

#  training data start/end
TrainDataStart = '2020-08-01' #214;
TrainDataEnd   = '2020-11-01' #306;
...
K0   = Cmax
ExpDataStart = '2020-08-09' #183+40=223
ExpDataEnd = '2020-09-20' #183+80=263
...
tau_ast = np.where(MyFit_I_env_lower > 0)
...
#  Figure 1 - prevalence
graphobj['gname'] = str(case_name) + '__C_vs_time_tau_' + str(tau0)
graphobj['gtitle'] = ''
graphobj['ymin']   = 0
graphobj['ymax']   = 5000
graphobj['xlab']   = []
...
#  Figure 2 - prevalence
graphobj['gname'] = str(case_name) + '__I_vs_time_tau_' + str(tau0)
graphobj['gtitle'] = ''
graphobj['ymin']   = 0
graphobj['ymax']   = 140
graphobj['taux']   = date[tau_ast[0][0]] #'2020-07-17 00:00:00'"
graphobj['tauy']   = 0.55
graphobj['tauh']   = 'left'
graphobj['xlab']   = []
