% -----------------------------------------------------------------
%  Main_COVID19_RegressionMC_4th_wave_RJ.m
% -----------------------------------------------------------------
...
DateEnd    = datenum('05-01-2021');
TrainStart = datenum('03-01-2021');
TrainEnd   = datenum('05-01-2021');
...
RawDataEnd   = 487;  % May 01, 2021

% training data start/end
TrainDataStart = 426;  % Mar 01, 2021
TrainDataEnd   = 487;  % May 01, 2021
...
K0   = Cmax;
r0   = RegressionExp(time(1:30),Data_I_raw(1:30));
tau0 = tImax;
