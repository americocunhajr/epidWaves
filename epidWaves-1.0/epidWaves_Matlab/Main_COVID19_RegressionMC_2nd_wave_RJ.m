% -----------------------------------------------------------------
%  Main_COVID19_RegressionMC_2nd_wave_RJ.m
% -----------------------------------------------------------------
...
% range of dates
DateStart  = datenum('07-01-2020');
DateEnd    = datenum('11-01-2020');
TrainStart = datenum('08-01-2020');
TrainEnd   = datenum('11-01-2020');
...
% raw data start/end
RawDataStart = 183;  % Jul 01, 2020
RawDataEnd   = 306;  % Nov 01, 2020

% training data start/end
TrainDataStart = 214;  % Aug 01, 2020
TrainDataEnd   = 306;  % Nov 01, 2020
...
K0   = Cmax;
r0   = RegressionExp(time(40:80),Data_I_raw(40:80));
tau0 = tImax;
