% -----------------------------------------------------------------
%  Main_COVID19_RegressionMC_3rd_wave_RJ.m
% -----------------------------------------------------------------
...
% range of dates
DateStart  = datenum('11-01-2020');
DateEnd    = datenum('03-01-2021');
TrainStart = datenum('11-01-2020');
TrainEnd   = datenum('02-01-2021');
...
% raw data start/end
RawDataStart = 306;  % Nov 01, 2020
RawDataEnd   = 426;  % Mar 01, 2021

% training data start/end
TrainDataStart = 306;  % Nov 01, 2020
TrainDataEnd   = 398;  % Feb 01, 2021
...
K0   = Cmax;
r0   = RegressionExp(time(1:40),Data_I_raw(1:40));
tau0 = tImax;
