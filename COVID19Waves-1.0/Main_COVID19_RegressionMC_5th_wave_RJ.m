...
time_train = linspace(TrainDataStart,TrainDataEnd,length(time_train))';
% ..........................................................
...
hold on
fig2b = plot(time(62:end),Data_I_raw(62:end),'o-m','LineWidth',1);
fig2c = plot(time(62:end),Data_I_MA(62:end)   ,'.-g','LineWidth',3);
